...
if __name__ == '__main__':
    ...
    true_label_p = np.loadtxt(os.path.join(file_path, 'tru_label_spiral_1.txt'))

    pre_acc_p_1 = np.loadtxt(os.path.join(file_path, 'pre_acc_spiral_1.txt'))
    ...
    pre_acc_p_2 = np.loadtxt(os.path.join(file_path, 'pre_acc_spiral_2.txt'))
    ...
    pre_acc_p_3 = np.loadtxt(os.path.join(file_path, 'pre_acc_spiral_3.txt'))
    ...
    pre_acc_p_4 = np.loadtxt(os.path.join(file_path, 'pre_acc_spiral_4.txt'))
    ...
    pre_acc_p_5 = np.loadtxt(os.path.join(file_path, 'pre_acc_spiral_5.txt'))
    ...
    # plt.ylabel('Sensitivity(in %)'.translate(sub_map), fontsize=25)
    # plt.xlabel('Threshold'.translate(sub_map), fontsize=25)
    # # plt.savefig("C:/Users/xuecwang/Desktop/pictures/c/thres_sensitivity.png", dpi=500, bbox_inches='tight')
    # plt.show()
    #
    fig = plt.figure(figsize=(10, 8))
    ax = fig.subplots()
    ...
    plt.xlabel('Threshold'.translate(sub_map), fontsize=25)
    # plt.savefig("C:/Users/xuecwang/Desktop/pictures/c/thres_accc.png", dpi=500, bbox_inches='tight')
    plt.show()
    #
    # fig = plt.figure(figsize=(10, 8))
    # ax = fig.subplots()
    ...
    # plt.xlabel('Threshold'.translate(sub_map), fontsize=25)
    # # plt.savefig("C:/Users/xuecwang/Desktop/pictures/c/thres_f1.png", dpi=500, bbox_inches='tight')
    # plt.show()
    #
    ...
    # plt.xlabel('Threshold'.translate(sub_map), fontsize=25)
    # # plt.savefig("C:/Users/xuecwang/Desktop/pictures/c/thres_mcc.png", dpi=500, bbox_inches='tight')
    # plt.show()
